...
def create_app() -> FastAPI:
    ...
    async def run(req: RunRequest):
        ...
        asyncio.create_task(process_conversion(job_id, input_path, output_path, req.output_format))
...
async def process_conversion(job_id: str, input_path: Path, output_path: Path, output_format: str):
